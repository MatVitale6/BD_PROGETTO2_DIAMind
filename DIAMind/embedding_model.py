...
_MODEL = SentenceTransformer("sentence-transformers/all-MiniLM-L6-v2")     # Modello che stiamo utilizzando


def embed_text(text: str, normalize: bool = True) -> np.ndarray:
    """ Funzione che riceve un testo e lo embeddizza """
...
def embed_many(texts: List[str], batch_size: int = 64, normalize: bool = True) -> np.ndarray:
    """ Funzione che riceve un elenco di testi e li embeddizza """
